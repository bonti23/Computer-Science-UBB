...
import static bonti.ResponseType.UPDATE;
...
public class BasketClientRpcWorker implements Runnable, IObserver {
    ...
    private Response handleRequest(Request request) {
        ...
        switch (request.type()) {
            ...
            case FILTER_GAMES: {
                ...
                String type_game = (String) request.data();
                try { // conversie String -> ENUM
                    var games = server.showcaseGamesByType(type_game);
                    return new Response.Builder()
            ...
            case CHECK_USERNAME: {
                ...
                boolean exists = server.findByUsername(username);
            ...
            case UPDATE_SEATS: {
                ...
                try {
                    Game updatedGame = server.updateSeats(game, seats);
                    return new Response.Builder()
            ...
            case FIND_BY_CLIENT: {
                ...
                try {
                    var purchases = server.findByClientOrderedBySeats(client);
                    return new Response.Builder()
            ...
            case ALL_PURCHASES: {
                System.out.println("All purchases request...");
                try {
                    var purchases = server.allPurchases();
                    return new Response.Builder()
                            .type(ResponseType.PURCHASES_FOUND)
                            .data(purchases)
                            .build();
    ...
    public void notifyBoughtSeats(Game game) throws Exception {
        System.out.println("Seats have been updated for game: " + game.getId());
