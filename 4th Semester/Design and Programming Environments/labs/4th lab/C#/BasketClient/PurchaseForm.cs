...
namespace BasketClient
{
    public partial class PurchaseForm : Form
    {
        ...
        public PurchaseForm(IService service, Game game)
        {
            ...
            if (this.selectedGame == null || this.selectedGame.get_identitykey() == 0)
            {
        ...
        private async void PurchaseButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                PurchaseDTO purchaseDTO = new PurchaseDTO(new Purchase(clientName, selectedGame.get_identitykey(), seats, address));
