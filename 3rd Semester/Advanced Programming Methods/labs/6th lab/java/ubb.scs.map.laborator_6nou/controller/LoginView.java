...
public class LoginView {
    ...
    public void handleRegisterButton(ActionEvent actionEvent) throws IOException {
        ...
        registerView.setService(userService, stage);  // Pass userService and stage

        stage.show();
    }

    public void setService(UserService userService, FriendshipService friendshipService, FriendshipRequestService friendshipRequestService) {
    ...
    public void handleLoginButton(ActionEvent actionEvent) throws IOException {
        ...
        if (loggedIn != null && loggedIn.getID() != null) {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/ubb/scs/map/laborator_6nou/main-menu-view.fxml"));
            AnchorPane root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = new Stage();
            stage.setScene(scene);
            ...
            mainMenuView.setService(loggedIn.getID(), userService, friendshipService, friendshipRequestService, stage);
