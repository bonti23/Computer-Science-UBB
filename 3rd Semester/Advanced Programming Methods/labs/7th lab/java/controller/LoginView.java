...
public class LoginView {
    ...
    public void setService(UserService userService, FriendshipService friendshipService, FriendshipRequestService friendshipRequestService, MessageService messageService) {
        ...
        this.messageService = messageService;  // Assign messageService here
    }
    ...
    public void handleLoginButton(ActionEvent actionEvent) throws IOException {
        ...
        // Assuming userService is properly set
        ...
        if (loggedIn != null && loggedIn.getID() != null) {
            ...
            // Assuming the main menu controller is properly linked and accepts parameters
            ...
            // Hide error message and show the new window
