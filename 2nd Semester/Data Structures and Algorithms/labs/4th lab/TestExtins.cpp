...
void testMultime() {
    ...
    //colectia va arata asa: 1 2 3 4 5
    int eliminari1 = c.transinMultime();
    assert(eliminari1 == 0);
    assert(c.dim() == 5);
    ...
    c.adauga(6);
    /*
     * colectia va arata asa: 1 2 2 2 3 3 3 4 5 5 6
     * rezulta ca eliminam 5: 2 2 3 3 5 (5 elemente)
    */
    int eliminari2 = c.transinMultime();
    assert(eliminari2 == 5);
    assert(c.dim() == 6);
}
