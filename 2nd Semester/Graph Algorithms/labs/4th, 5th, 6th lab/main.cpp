...
void Flux_Maxim__Pompare_Topologica() {
    printf("Flux_Maxim_Pompare_Topologica\n");
}
/*
5 6
0 1 5
...
void  Flux_Maxim__Pompare_Preflux() {
    cout << "Flux_Maxim__Pompare_Preflux\n";
}
/*
...
int main() {
    ...
    Flux_Maxim__Pompare_Preflux();
    Flux_Maxim__Pompare_Topologica(); 
    Ciclu_Eulerian();
